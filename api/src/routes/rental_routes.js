...
router.patch("/:id/cancel", auth, isAdmin, rentalController.cancel);
...
router.patch(
  "/:rentalId/items/:itemId",
  auth,
  isAdmin,
  rentalController.updateItem,
);
router.delete(
  "/:rentalId/items/:itemId",
  auth,
  isAdmin,
  rentalController.removeItem,
);
...
router.get(
  ...
  auth,
  isAdmin,
  rentalController.getRentalReservations,
);
...
router.patch(
  ...
  auth,
  isAdmin,
  returnController.updatePenalty,
);
router.delete(
  "/:id/penalties/:penaltyId",
  auth,
  isAdmin,
  returnController.removePenalty,
);
...
router.post(
  ...
  auth,
  isAdmin,
  returnController.createDeposit,
);
router.patch(
  "/:rentalId/deposit",
  auth,
  isAdmin,
  returnController.updateDeposit,
);
router.patch(
  "/:id/deposit/refund",
  auth,
  isAdmin,
  returnController.refundDeposit,
);
router.patch(
  "/:rentalId/deposit/deduct",
  auth,
  isAdmin,
  returnController.deductDeposit,
);
